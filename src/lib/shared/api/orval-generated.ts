 ...
 */
export type getApiEmbedUuidProfileIdResponse200 = {
  data: ModelsEmbedData;
  status: 200;
};

export type getApiEmbedUuidProfileIdResponse400 = {
  data: ModelsProcessingError;
  status: 400;
};

export type getApiEmbedUuidProfileIdResponse500 = {
  data: ModelsProcessingError;
  status: 500;
};

export type getApiEmbedUuidProfileIdResponseSuccess = getApiEmbedUuidProfileIdResponse200 & {
  headers: Headers;
};
export type getApiEmbedUuidProfileIdResponseError = (getApiEmbedUuidProfileIdResponse400 | getApiEmbedUuidProfileIdResponse500) & {
  headers: Headers;
};

export type getApiEmbedUuidProfileIdResponse = getApiEmbedUuidProfileIdResponseSuccess | getApiEmbedUuidProfileIdResponseError;

export const getGetApiEmbedUuidProfileIdUrl = (uuid: string, profileId?: string) => {
 ...
 */
export type getApiInventoryUuidProfileIdSearchSearchResponse200 = {
  data: ModelsStrippedItem[];
  status: 200;
};

export type getApiInventoryUuidProfileIdSearchSearchResponse400 = {
  data: ModelsProcessingError;
  status: 400;
};

export type getApiInventoryUuidProfileIdSearchSearchResponse500 = {
  data: ModelsProcessingError;
  status: 500;
};

export type getApiInventoryUuidProfileIdSearchSearchResponseSuccess = getApiInventoryUuidProfileIdSearchSearchResponse200 & {
  headers: Headers;
};
export type getApiInventoryUuidProfileIdSearchSearchResponseError = (getApiInventoryUuidProfileIdSearchSearchResponse400 | getApiInventoryUuidProfileIdSearchSearchResponse500) & {
  headers: Headers;
};

export type getApiInventoryUuidProfileIdSearchSearchResponse = getApiInventoryUuidProfileIdSearchSearchResponseSuccess | getApiInventoryUuidProfileIdSearchSearchResponseError;

export const getGetApiInventoryUuidProfileIdSearchSearchUrl = (uuid: string, profileId: string, search?: string) => {
  return `/api/inventory/${uuid}/${profileId}/search/${search}`;
};

export const getApiInventoryUuidProfileIdSearchSearch = async (uuid: string, profileId: string, search?: string, options?: RequestInit): Promise<getApiInventoryUuidProfileIdSearchSearchResponse> => {
  return customFetch<getApiInventoryUuidProfileIdSearchSearchResponse>(getGetApiInventoryUuidProfileIdSearchSearchUrl(uuid, profileId, search), {
    ...options,
    method: "GET"
  });
};
...
export const getGetApiInventoryUuidProfileIdInventoryIdUrl = (uuid: string, profileId: string, inventoryId: string) => {
  return `/api/inventory/${uuid}/${profileId}/${inventoryId}`;
};

export const getApiInventoryUuidProfileIdInventoryId = async (uuid: string, profileId: string, inventoryId: string, options?: RequestInit): Promise<getApiInventoryUuidProfileIdInventoryIdResponse> => {
  return customFetch<getApiInventoryUuidProfileIdInventoryIdResponse>(getGetApiInventoryUuidProfileIdInventoryIdUrl(uuid, profileId, inventoryId), {
    ...options,
    method: "GET"
  });
};
