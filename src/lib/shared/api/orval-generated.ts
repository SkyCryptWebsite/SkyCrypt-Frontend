...
/**
 * HideFlags int `nbt:"HideFlags" json:"HideFlags,omitempty"` Unbreakable int `nbt:"Unbreakable"
 * json:"Unbreakable,omitempty"` Enchantments []Enchantment `nbt:"ench" json:"ench,omitempty"`
 */
 ...
 * @summary List emojis
 */
export const listEmojis = async (options?: Parameters<typeof customFetch>[1]): Promise<listEmojisResponse> => {
 ...
 */
export const renderHeadImage = async (
  textureId: string,
  options?: Parameters<typeof customFetch>[1]
): Promise<renderHeadImageResponse> => {
...
export const renderItemImage = async (
  itemId: string,
  options?: Parameters<typeof customFetch>[1]
): Promise<renderItemImageResponse> => {
 ...
 */
export const resolveItemImage = async (
  itemId: string,
  options?: Parameters<typeof customFetch>[1]
): Promise<resolveItemImageResponse> => {
 ...
 */
export const getSourceInfo = async (options?: Parameters<typeof customFetch>[1]): Promise<getSourceInfoResponse> => {
