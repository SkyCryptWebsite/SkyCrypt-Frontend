...
export type getApiSourceResponse200 = {
  data: ModelsSourceInfo;
  status: 200;
};

export type getApiSourceResponseSuccess = getApiSourceResponse200 & {
  headers: Headers;
};
export type getApiSourceResponse = getApiSourceResponseSuccess;

export const getGetApiSourceUrl = () => {
  return `/api/source`;
};

/**
 * Returns source and license information for the running SkyCrypt Backend service.
 * @summary Get source and license information
 */
export const getApiSource = async (options?: RequestInit): Promise<getApiSourceResponse> => {
  return customFetch<getApiSourceResponse>(getGetApiSourceUrl(), {
    ...options,
    method: "GET"
  });
};
