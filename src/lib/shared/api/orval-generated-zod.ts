...
export const getApiAccessoriesUuidProfileIdResponse = zod.object({
  accessories: zod
    .array(
      zod.object({
...
export const getApiBestiaryUuidProfileIdResponse = zod.object({
  categories: zod
    .record(
      zod.string(),
      zod.object({
...
export const getApiCollectionsUuidProfileIdResponse = zod.object({
  categories: zod
    .record(
      zod.string(),
      zod.object({
...
export const getApiCrimsonIsleUuidProfileIdResponse = zod.object({
  dojo: zod
    .object({
      challenges: zod
        .array(
...
export const getApiDungeonsUuidProfileIdResponse = zod.object({
  catacombs: zod
    .array(
      zod.object({
        best_run: zod
 ...
 */
export const getApiEmbedUuidProfileIdParams = zod.object({
  uuid: zod.string().describe("User UUID or username"),
  profileId: zod.string().optional().describe("Profile ID (optional)")
});

export const getApiEmbedUuidProfileIdResponse = zod.object({
...
export const getApiGardenProfileIdResponse = zod.object({
...
export const getApiGearUuidProfileIdResponse = zod.object({
  armor: zod
    .object({
      armor: zod
        .array(
 ...
 */
export const getApiInventoryUuidProfileIdSearchSearchParams = zod.object({
  uuid: zod.string().describe("User UUID"),
  profileId: zod.string().describe("Profile ID"),
...
export const getApiInventoryUuidProfileIdSearchSearchResponseItem = zod.object({
  Count: zod.number().optional(),
  containsItems: zod.array(zod.unknown()).optional(),
  display_name: zod.string().optional(),
  isInactive: zod.boolean().optional(),
...
export const getApiInventoryUuidProfileIdSearchSearchResponse = zod.array(getApiInventoryUuidProfileIdSearchSearchResponseItem);
...
export const getApiMinionsUuidProfileIdResponse = zod.object({
...
export const getApiMiscUuidProfileIdResponse = zod.object({
  auctions: zod
    .object({
...
export const getApiPetsUuidProfileIdResponse = zod.object({
  amount: zod.number().optional(),
...
export const getApiRiftUuidProfileIdResponse = zod.object({
  armor: zod
    .object({
      armor: zod
        .array(
...
export const getApiSkillsUuidProfileIdResponse = zod.object({
  enchanting: zod
    .object({
      data: zod
        .record(
...
export const getApiSlayerUuidProfileIdResponse = zod.object({
  data: zod
    .record(
      zod.string(),
      zod.object({
